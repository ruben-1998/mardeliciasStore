      ...
      {value ? (
        <TouchableOpacity onPress={callback} style={styles.containerSelect}>
          <View style={styles.row}>
            <Icon customStyles={stylesIcon} icon={value.icon} />
            <View style={{flexDirection: 'column'}}>
              <Typography style={styles.textShippingType}>
                {value.title}
              </Typography>
              {value?.description && showDescriptionValue && (
                <Typography style={styles.textDescription}>
                  {value?.description}
                </Typography>
              )}
            </View>
